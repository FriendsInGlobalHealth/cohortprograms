...
public class UtilsTest {
	...
	private final String SINGLE_PATIENT_SANTE_JSON = IOUtils.toString(getClass().getResourceAsStream("/opencr/single_patient_sante.json"));
	...
	public void getOpenmrsUuidFromFhirIdentifiers_shouldReturnPatientUuid() {
		...
		assertEquals(expectedUuid, Utils.getOpenmrsUuidFromFhirIdentifiers(patient.getIdentifier(), patientUuidFhirSystemValue));
	}
