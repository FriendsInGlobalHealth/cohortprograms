...
public class OpencrSearchDelegate {
	...
	public Bundle searchOpencrForPatients(final String searchText) throws Exception {
		...
		try {
			...
			if (opencrResponse != null) {
				opencrResponse.close();
			}
		}
	}
	...
	@Transactional
	public org.openmrs.Patient importOpencrPatient(@NotNull final Patient patientResource) throws Exception {
		...
		String openmrsUuid = Utils.getOpenmrsUuidFromOpencrIdentifiers(patientResource.getIdentifier(),
